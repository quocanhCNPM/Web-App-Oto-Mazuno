...
const ChangeUserRole = ({
  ...
  return (
    ...
    <div className='fixed top-0 bottom-0 left-0 right-0 w-full h-full z-10 flex justify-between items-center '>
       <div className='mx-auto bg-gradient-to-r from-indigo-100 via-purple-500 to-gray-500 ... shadow-md p-4 w-full max-w-sm customShadown'>

            <button className='block ml-auto hover:bg-red-700' onClick={onClose}>
                <IoMdClose/>
            </button>
